...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QRect(260, 200, 111, 31))
        self.pushButton.setFont(font)
        self.fileFromButton = QPushButton(self.centralwidget)
        self.fileFromButton.setObjectName(u"fileFromButton")
        self.fileFromButton.setGeometry(QRect(100, 200, 131, 28))
        self.fileFromButton.setFont(font)
        self.selectFilesLabel = QLabel(self.centralwidget)
        self.selectFilesLabel.setObjectName(u"selectFilesLabel")
        self.selectFilesLabel.setGeometry(QRect(20, 270, 421, 191))
        self.selectFilesLabel.setAlignment(Qt.AlignCenter)
